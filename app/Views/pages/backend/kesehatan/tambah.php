...
<?= $this->section('title') ?>Tambah Berita Kesehatan<?= $this->endSection() ?>
<?= $this->section('content') ?>
<nav class="navbar navbar-expand-lg">
    <h1 class="p-2"><b>Form Tambah Berita Kesehatan</b></h1>
</nav>
<section class="content">
    <div class="main-content">
        <div class="container">
            ...
            <?php endif ?>
            <form id="tambahBeritaForm" action="<?php echo base_url('admin/kesehatan/simpan') ?>" method="post" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-8">
